...
class RegistrationFormsFactory
{
    ...
    private function createBasicRegistrationForm(): BootstrapForm
    {
        ...
        $form->addText("firstname", $this->labelsHelper->getLabel("firstname"))
                ...
                ->setHtmlAttribute("placeholder", $this->labelsHelper->getLabel("firstname"))
        ...
        $form->addText("surname", $this->labelsHelper->getLabel("surname"))
                ...
                ->setHtmlAttribute("placeholder", $this->labelsHelper->getLabel("surname"))
                ->addRule(Form::MAX_LENGTH, "Surname is too long", 255);
        $form->addText("email", $this->labelsHelper->getLabel("email"))
                ->setHtmlAttribute("placeholder", $this->labelsHelper->getLabel("email"))
        ...
        $form->addText("nmo", $this->labelsHelper->getLabel("nmo"))
                ...
                ->setHtmlAttribute("placeholder", "National Member Organization")
        ...
        $form->addText("nmoPosition", $this->labelsHelper->getLabel("nmoPosition"))
                ...
                ->setHtmlAttribute("placeholder", "Position in National Member Organization")
        ...
        $form->addText("universityFaculty", $this->labelsHelper->getLabel("universityFaculty"))
                ...
                ->setHtmlAttribute("placeholder", $this->labelsHelper->getLabel("universityFaculty"))
        ...
        $form->addTextArea("motivation", $this->labelsHelper->getLabel("motivation"))
                ...
                ->setHtmlAttribute("placeholder", "Motivation")
    ...
    public function createTntRegistrationForm(): BootstrapForm
    {
        ...
        $form->addTextArea("tntStrengthsAsTrainer", $this->labelsHelper->getLabel("tntStrengthsAsTrainer"))
                ...
                ->setHtmlAttribute("placeholder", "Strengths as Trainer")
        ...
        $form->addTextArea("tntVisionAsTrainer", $this->labelsHelper->getLabel("tntVisionAsTrainer"))
                ...
                ->setHtmlAttribute("placeholder", "Vision as Trainer")
        ...
        $form->addTextArea("tntUsageOfKnowledge", $this->labelsHelper->getLabel("tntUsageOfKnowledge"))
                ...
                ->setHtmlAttribute("placeholder", "Usage of Gained Knowledge")
     ...
     * @param object $values
     */
    public function pretRegistrationFormSucceeded(BootstrapForm $form, $values): void
    {
     ...
     * @param object $values
     */
    public function tntRegistrationFormSucceeded(BootstrapForm $form, $values): void
    {
        $participant = $this->createBasicParticipant($form, $values);
        $participant->setTnt();
        $participant->setTntStrengthsAsTrainer($values->tntStrengthsAsTrainer);
        $participant->setTntVisionAsTrainer($values->tntVisionAsTrainer);
        $participant->setTntUsageOfKnowledge($values->tntUsageOfKnowledge);
        $this->participants->persist($participant);
